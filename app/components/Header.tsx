  ...
  return (
    <>
      <motion.header
        ...
        style={hasAnimated ? { transform: "none", opacity: 1 } : undefined}
          ...
          <div className="flex items-center justify-between h-14 lg:h-16">
            ...
            >
              <div className="relative">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-400 flex items-center justify-center shadow-[0_0_20px_rgba(99,102,241,0.3)]">
            ...
            <nav className="hidden lg:flex items-center gap-2 px-2 py-1 rounded-full bg-white/[0.02] border border-white/[0.05] backdrop-blur-md">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="relative px-5 py-2 text-sm font-medium text-slate-400 hover:text-white transition-colors rounded-full hover:bg-white/5"
                >
                  {link.label}
                </a>
              ))}
            ...
            <div className="hidden lg:flex items-center gap-4">
              <a
                href="/contact"
                className="relative group px-6 py-2.5 text-sm font-bold text-white bg-indigo-600 rounded-xl overflow-hidden shadow-[0_0_20px_rgba(79,70,229,0.3)] hover:shadow-[0_0_30px_rgba(79,70,229,0.5)] transition-shadow duration-300"
              >
            ...
            <button
              ...
              className="lg:hidden p-2.5 rounded-xl text-slate-300 hover:text-white transition-colors"
